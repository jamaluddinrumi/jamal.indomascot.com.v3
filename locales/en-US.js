export default {
  company: "INDOMASCOT",
  title: "Just Another Allah's Servant",
  home: "Home",
  search: "Search",
  welcome: "Welcome",
  ...
  aboutEstimatesEtc: "about estimates and etc, please contact us",
  weProduce:
    "More than hundreds of MSMEs, communities and government institutions have trusted us to produce custom mascot clown costumes with their own designs for events, socialization, promotions and branding purposes.",
  ...
  generalTerms: {
    ...
    li4: {
      shipping: "Shipping",
      pickInWorkshop: "Pick In Workshop",
      youCanPickInWorkshop:
        "Costumes can be picked up in person at our workshop which is located at:",
  ...
  lastEdited: "Last edited: March, 9 2022",
  ...
  freeBonusHeadFanAndMask: "Free Bonus Head Fan & Mask",
  performerIsSweating:
  ...
  howToOrderMascotCostumeSteps: {
    step0: "Client Do",
    step1: "Client Send Us Design",
    step2: "We Send Offer Letters",
    step3: "Client Makes DP (Down Payment)",
    step4: {
      0: "We Send Final Photos",
      1: "Front View Final Photo Progress",
      2: "Side View Final Photo Progress",
      3: "Rear View Final Photo Progress",
    },
    step5: "Client Makes Full Payment",
    step6: "We Do Shipping",
  },
  description: {
    index:
  ...
  fittingInstruction: {
    ...
    resizeDragRotate: "design if needed.",
    removeBg: "Use background removal like",
    png: "File must be in ",
    screenshot: {
      send: "Send the",
      toUs: "of the design that already proportioned to us.",
    },
  },
  apps: "Apps",
  install: "Install",
