export default {
  ...
  aboutEstimatesEtc: "mengenai surat penawaran dan lain-lainnya, mohon hubungi",
  weProduce:
  ...
  aboutUsParagraph: {
    ...
    p3: "Dengan berbekal pengalaman & relasi yang lebih dari 10 tahun, kami yakin dapat membantu kegiatan pemasaran perusahaan anda seperti memeriahkan event sehingga mendapatkan perhatian dari potential customer anda.",
    p4: "Ketika sudah mencapai kondisi telah mendapatkan perhatian, maka akan sangat lebih mudah bagi Anda untuk menyampaikan informasi yang ingin anda sampaikan kepada potential customer anda.",
  ...
  generalTerms: {
    li3: "Proses pembuatan baru akan dimulai 1 hari setelah DP & desain maskot diterima.",
    li4: {
      shipping: "Pengiriman",
  ...
  mascotCostumeTerms: {
    ...
    li1: "DP (Down Payment) untuk tiap 1 unitnya adalah Rp1.500.000,-.",
  ...
  lastEdited: "Terakhir disunting: 9 Maret 2022",
  ...
  whatIsTheDifferent: "Apa bedanya dengan baju badut?",
  itsJustTheSame:
  ...
  toSatisfy:
    "Untuk memuaskan klien, kami hanya menggunakan kain yang berkualitas no #1 di market. Kain ini tidak panas dan lembut. Mulai dari jenis velboa (boneka), drill hingga lotto yang beraneka ragam warna untuk mendapatkan hasil yang mirip dengan desain aslinya.",
  ...
  freeBonusHeadFanAndMask: "Bonus Kipas & Masker",
  performerIsSweating:
    "Performer (pemakai) kostum pastinya sangat mudah berkeringat dikarenakan suhu yang hangat di dalam topengnya. We care about that! Serta turut andil kami dalam usaha memerangi COVID-19, perlu juga mensosialisasikan pemakaian masker bagi maskot anda ketika perform. Maka dari itu, jika memungkinkan kami berikan bonus exhaust head fan & masker (gratis).",
